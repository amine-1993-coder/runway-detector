    ...
    def generateImage(self):
        ...
        for x in range(0, self._nb_tiles):
            for y in range(0, self._nb_tiles):
                ...
                map_img.paste(im.crop((border, border, self._tile_size + border, self._tile_size + border)),
...
def run_example(latitude, longitude, map_size, img_size, file_name):
    ...
    # 49.19472222222222, -123.18388888888887
    #gmap_key = "AIzaSyCr4Ll_06uh3iv2eQQBKViwHPLCixnBxRw"
    import csv
    ...
    try:
       ...
       messagebox.showerror("ERROR", "Could not generate the image - use another key or change the location")
       print("ERROR: Could not generate the image - use another key or change the location")
        ...
        from tkinter import messagebox
        messagebox.showinfo("INFO", "The map has successfully been created")
